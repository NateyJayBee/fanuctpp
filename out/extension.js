...
function activate(context) {
    ...
    context.subscriptions.push(disposeOpen, disposeDebounceChange, disposeLabelView, disposeNameView, disposeActiveEditorChange, disposableCommand, disposeBackupView, disposeBackupManagerView);
}
function deactivate() { }
