...
import { keyToString } from '../constants';

// Function to generate the HTML content for the Name Webview
export function getNameWebContent(document: vscode.TextDocument, groupedNames: { [type: string]: { item: string, name: string, lines: number[] }[] }, groupState: { [key: string]: boolean }): string {
